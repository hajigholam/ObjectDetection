...
Original file is located at
    https://colab.research.google.com/drive/1eL_6Y-Crs-bCrq4XmXqQM8TAuZFRN2fp

#Develop and deploy computer vision model to detect common objects in pictures

## Model development:
Open CV + YOLOV3 pretreained model
"""
